This repository includes an example plugin, `demo` using [http-wasm](https://http-wasm.io/) and the WasmEdge socket extension to make http calls, for you to use as a reference for developing your own plugins.
